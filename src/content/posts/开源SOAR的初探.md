...
tags: [SOAR]
category: 企业安全建设
description: '本文是一篇关于开源SOAR平台OctoMation的初探与实践记录。文章详细介绍了从环境准备、SOAR搭建、剧本导入与尝试，到蜜罐搭建以及与SOAR联动的全过程。其中，重点展示了如何将蜜罐（HFish）捕获的攻击日志通过Syslog和Kafka发送给SOAR，并触发预设剧本实现飞书告警。此外，文章还总结了作者在搭建过程中遇到的各种“踩坑点”，并记录了尝试集成阿里云云防火墙和雷池WAF但最终放弃的过程与原因，为读者提供了宝贵的实践经验。'
---
