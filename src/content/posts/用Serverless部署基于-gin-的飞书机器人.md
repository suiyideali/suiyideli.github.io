...
category: 杂谈
tags: [飞书 Go 机器人]
description: '本文是一篇使用Serverless架构部署基于Gin框架的飞书机器人的教程。文章详细介绍了从环境准备、项目初始化、配置文件修改，到项目部署发布的完整流程。其中，重点讲解了如何通过Serverless Devs CLI工具进行部署，以及如何配置飞书开放平台的相关凭证和事件订阅。最后，还演示了如何在飞书群聊中上线并使用该机器人，并附有详细的截图和命令行示例。'
---
